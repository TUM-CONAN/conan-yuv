## Conan package recipe for [*yuv*](https://github.com/ulricheck/libyuv)

a C++ libary to parse yuv files
...
### Basic setup
    ...
    $ conan install yuv/1749@camposs/stable
